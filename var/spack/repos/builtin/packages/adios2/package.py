...
class Adios2(CMakePackage):
    ...
    variant("dataman", default=False, description="Enable the DataMan engine for WAN transports")
    ...
    def libs(self):
        ...
        if spec.satisfies("@2.6:"):
            ...
            if self.spec.satisfies("@2.7: +shared+hdf5") and self.spec["hdf5"].satisfies("@1.12:"):
