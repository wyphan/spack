...
class Openmpi(AutotoolsPackage):
    ...
    variant("wrapper-rpath", default=True, description="Enable rpath support in the wrappers")
    ...
    variant(
        "singularity", default=False, description="Build support for the Singularity container"
    )
    ...
    conflicts("+cxx_exceptions", when="@5:", msg="C++ exceptions are removed in 5.0.X release")
    ...
    conflicts("+singularity", when="@5:", msg="singularity support has been dropped in OpenMPI 5")
