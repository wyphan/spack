...
class Adiak(CMakePackage):
    ...
    version("0.3.0-alpha", commit="054d2693a977ed0e1f16c665b4966bb90924779e", submodules=True)
    version(
        "0.2.1", commit="950e3bfb91519ecb7b7ee7fa3063bfab23c0e2c9", submodules=True, preferred=True
    )
