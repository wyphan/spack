...
class Nsimd(CMakePackage):
    ...
    conflicts("simd=SVE128", when=("@:1"), msg="SIMD extension not available in version @:1")
    conflicts("simd=SVE256", when=("@:1"), msg="SIMD extension not available in version @:1")
    conflicts("simd=SVE512", when=("@:1"), msg="SIMD extension not available in version @:1")
    conflicts("simd=SVE1024", when=("@:1"), msg="SIMD extension not available in version @:1")
    conflicts("simd=SVE2048", when=("@:1"), msg="SIMD extension not available in version @:1")
    conflicts("simd=VMX", when=("@:2"), msg="SIMD extension not available in version @:2")
    conflicts("simd=VSX", when=("@:2"), msg="SIMD extension not available in version @:2")
    conflicts("simd=CUDA", when=("@:1"), msg="SIMD extension not available in version @:1")
    conflicts("simd=ROCM", when=("@:1"), msg="SIMD extension not available in version @:1")
    conflicts("optionals=FMA", when=("@2:"), msg="SIMD optionals not available in version @2:")
    conflicts("optionals=FP16", when=("@2:"), msg="SIMD optionals not available in version @2:")
    conflicts(
        "optionals=FMA,FP16", when=("@2:"), msg="SIMD optionals not available in version @2:"
    )
