...
class Ucx(AutotoolsPackage, CudaPackage):
    ...
    variant("mlx5-dv", default=False, description="Compile with mlx5 Direct Verbs support")
    variant("ib-hw-tm", default=False, description="Compile with IB Tag Matching support")
    variant("dm", default=False, description="Compile with Device Memory support")
    variant("cm", default=False, description="Compile with IB Connection Manager support")
    variant(
        "backtrace-detail",
        default=False,
