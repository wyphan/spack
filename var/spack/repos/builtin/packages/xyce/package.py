...
class Xyce(CMakePackage):
    ...
    depends_on(
        "trilinos@12.12.1 +amesos+amesos2+anasazi+aztec+basker+belos+complex"
        "+epetra+epetraext+explicit_template_instantiation+fortran+hdf5+ifpack"
        "+isorropia+kokkos+nox+sacado+suite-sparse+trilinoscouplings+zoltan"
        "+stokhos+epetraextbtf+epetraextexperimental+epetraextgraphreorderings "
        "gotype=all"
    )
