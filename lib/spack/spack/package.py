    ...
    **Package Lifecycle**
    ...
    def dependencies_of_type(self, *deptypes):
        ...
        return dict(
            ...
            if any(dt in self.dependencies[name][cond].type for cond in conds for dt in deptypes)
        )
    ...
    def content_hash(self, content=None):
        ...
        if not self.spec.concrete:
            err_msg = (
                "Cannot invoke content_hash on a package" " if the associated spec is not concrete"
            )
