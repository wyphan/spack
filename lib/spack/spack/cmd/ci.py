...
def ci_rebuild(args):
    ...
    matches = bindist.get_mirrors_for_spec(job_spec, full_hash_match=True, index_only=False)
    ...
    if matches:
        ...
        tty.msg("No need to rebuild {0}, found full hash match at: ".format(job_spec_pkg_name))
        ...
        if enable_artifacts_mirror:
            ...
            bindist.download_single_spec(
                job_spec, build_cache_dir, require_cdashid=False, mirror_url=matching_mirror
            )
    ...
    if enable_cdash:
        ...
        (cdash_build_id, cdash_build_stamp) = spack_ci.register_cdash_build(
            cdash_build_name, cdash_base_url, cdash_project, cdash_site, job_spec_buildgroup
        )
    ...
    if install_exit_code == 0:
        ...
        if buildcache_mirror_url:
            ...
            if cdash_build_id:
                ...
                spack_ci.write_cdashid_to_mirror(cdash_build_id, job_spec, buildcache_mirror_url)
        ...
        if pipeline_mirror_url:
            ...
            if cdash_build_id:
                ...
                spack_ci.write_cdashid_to_mirror(cdash_build_id, job_spec, pipeline_mirror_url)
