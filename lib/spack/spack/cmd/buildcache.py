...
def download_fn(args):
    ...
    result = bindist.download_single_spec(spec, args.path, require_cdashid=args.require_cdashid)
...
def copy_fn(args):
    ...
    cdashidfile_rel_path = os.path.join(build_cache_dir, bindist.tarball_name(spec, ".cdashid"))
