    ...
    def mock_do_request(self, endpoint, *args, **kwargs):
        ...
        # New Build
            ...
            return {
                ...
                "data": {"build_created": True, "build_environment_created": True, "build": build},
                "code": 201,
            }
        ...
        # Send Analyze Metadata
            ...
            return {"message": "Metadata updated", "data": {"build": build}, "code": 200}
        ...
        # Update Build Phase
            ...
            return {
                ...
                "code": 200,
                "data": {"build_phase": {"id": 1, "status": "SUCCESS", "name": "autoconf"}},
            }
...
def test_install_monitor_save_local(install_mockery_mutable_config, mock_fetch, tmpdir_factory):
    """
