...
@pytest.mark.parametrize("directory", glob.iglob(os.path.join(DATA_PATH, "make", "negative", "*")))
...
class TestSourceforgePackage(object):
    def test_define(self):
        ...
        assert pkg.urls[0] == "https://prdownloads.sourceforge.net/" "tcl/tcl8.6.5-src.tar.gz"
