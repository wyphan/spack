...
def test_packages_path():
    assert spack.cmd.pkg.packages_path() == spack.repo.path.get_repo("builtin").packages_path


def test_mock_packages_path(mock_packages):
    assert spack.cmd.pkg.packages_path() == spack.repo.path.get_repo("builtin.mock").packages_path
