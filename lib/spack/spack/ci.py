...
SPACK_SHARED_PR_MIRROR_URL = url_util.join(SPACK_PR_MIRRORS_ROOT_URL, "shared_pr_mirror")
...
def generate_gitlab_ci_yaml(
    ...
    if pr_mirror_url:
        ...
        spack.mirror.add(
            "ci_shared_pr_mirror", SPACK_SHARED_PR_MIRROR_URL, cfg.default_modify_scope()
        )
    ...
    for phase in phases:
        ...
        for stage_jobs in stages:
            ...
            for spec_label in stage_jobs:
                ...
                if broken_spec_urls is not None and release_spec_full_hash in broken_spec_urls:
